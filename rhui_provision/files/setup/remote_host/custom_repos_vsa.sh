...
r
c
rhui-client-config-rhel-server-6-x86_64-vsa
Red Hat Update Infrastructure 2.0 Client Configuration Server 6 VSA 1.0
rhui-client-config/rhel/server/6/x86_64/vsa/1.0
2
y
rhui-client-config/rhel/server/6/\$basearch/vsa/1.0
y
n
n
y
